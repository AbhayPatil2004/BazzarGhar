...
import StoreDetailsWithAddProduct from "./components/StoreProductsWithAddProduct";
import AddProductHeading from "./components/AddProductHeading";
import QuickGuidelines from "./components/QuickGuideLines";
import AddProductFooter from "./components/AddProductFooter";

export default function Page(){

    return(
        <div>
            <AddProductHeading></AddProductHeading>
            <QuickGuidelines></QuickGuidelines>
            <StoreDetailsWithAddProduct></StoreDetailsWithAddProduct>
            <AddProductFooter></AddProductFooter>
        </div>
    )
}