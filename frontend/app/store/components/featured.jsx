        ...
        async function fetchFeaturedStores() {
            try {
                const res = await fetch(
                    `${process.env.NEXT_PUBLIC_API_URL}/store/featured`
                );
            ...
            <div className="mb-6 px-4 sm:px-6 flex items-center justify-between gap-3">
                ...
                <div className="flex-1">
                    ...
                    <p className="mt-1 text-gray-600 text-xs sm:text-sm">
                        Discover handpicked premium stores with enhanced visibility.
                    </p>
                </div>
            ...
            <div className="relative">
                ...
                >
                    {stores.map((store) => (
                        ...
                        >
                            {/* Premium Badge */}
                            <span className="absolute top-2 left-2 bg-blue-600 text-white text-[10px] px-2 py-1 rounded-full shadow z-10">
                                Premium
                            </span>
