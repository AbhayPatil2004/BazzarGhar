  ...
  return (
    <div className="relative group/row">
      ...
      {canLeft && (
        <button
          onClick={() => scrollBy(-1)}
          className="cursor-pointer absolute left-2 top-1/2 -translate-y-1/2 z-20 flex items-center justify-center w-10 h-10 sm:w-11 sm:h-11 rounded-full bg-gradient-to-r from-blue-500 to-blue-600 backdrop-blur-md border border-blue-400 shadow-lg text-white hover:shadow-xl hover:scale-110 transition-all duration-200 active:scale-95"
        >
          <ChevronLeft size={20} />
        </button>
      )}
